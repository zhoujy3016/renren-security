$(function () {
    ...
    $("#jqGrid").jqGrid({
        url: baseURL + 'eva/bteresult/list/' + arrParam['evalId'],
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		exportResult:function() {
			window.location.href = baseURL + "eva/bteresult/exportResult/" + vm.evalId;
		},
		// 具体建议导出
		exportSuggest:function() {
			window.location.href = baseURL + "eva/bteresult/exportSuggest/" + vm.evalId;
		}
	}
});